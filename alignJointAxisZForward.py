...
# mjm = True: joints can be moved without modifying the skinning (skining�� �������� �ʰ� joint�� ���� ����)
# After modifying joints, set the mjm=False for taking the skin out of move joints mode(joint ���� �Ŀ� False�� �����ϱ�)
...
# rootJoint: the root joint of the original skeleton (aligning�� skeleton�� root joint)
# copyRootJoint: the root joint of the copied skeleton (�� ���縦 ���� ������ skeleton�� root joint)
