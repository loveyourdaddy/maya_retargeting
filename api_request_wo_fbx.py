...
python api_request_wo_fbx.py ./models/SMPL/SMPL.fbx ./motions/SMPL/dancing.bvh ./models/Adori/Adori.fbx
python api_request_wo_fbx.py SMPL.fbx ./motions/SMPL/dancing.bvh Adori.fbx  
"""
