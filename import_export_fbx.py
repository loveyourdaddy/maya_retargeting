...
def get_parser():
    ...
    parser.add_argument('--SrcMotionDir', type=str, default="D:/2024_KAI_Retargeting/Adori/animation/0055_Freestyle002_03_RT0214.fbx")
    parser.add_argument('--TgtCharDir', type=str, default="D:/2024_KAI_Retargeting/Adori/SKM_ADORI_0229.fbx")
    parser.add_argument('--TgtMotionDir', type=str, default="D:/2024_KAI_Retargeting/Adori/exported.fbx")
    return parser
